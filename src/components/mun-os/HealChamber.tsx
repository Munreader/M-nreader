...
const VISITOR_MODE = false; // 🔓 ALL FEATURES UNLOCKED - Full Mün OS Experience
...
const PROFILE_MODULES = [
  ...
  { id: "personalize", name: "Personalize", description: "Themes • Environments", color: "#a855f7", icon: "🎨", locked: false },
  { id: "command", name: "Command Center", description: "System • Settings", color: "#ff69b4", icon: "⚙️", locked: false },
];
